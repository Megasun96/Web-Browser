    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        srBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                dialog.setTitle("Stefan doing Search");
                dialog.setHeaderText("Stefan doing search");
        ...
        // Stefan doing site labels
        Label StefanL = new Label("Stefan");
        StefanL.setId("titId");
        ...
        AnchorPane st = new AnchorPane(StefanL, dots, siteL, minBtn, maxBtn, closeBtn);
        AnchorPane.setLeftAnchor(StefanL, 10.0);
        AnchorPane.setTopAnchor(StefanL, 5.0);
        AnchorPane.setLeftAnchor(dots, 60.0);
        AnchorPane.setTopAnchor(dots, 6.0);
        AnchorPane.setLeftAnchor(siteL, 95.0);
        AnchorPane.setTopAnchor(siteL, 6.0);
        AnchorPane.setRightAnchor(closeBtn, 5.0);
        AnchorPane.setRightAnchor(maxBtn, closeBtn.getWidth() + 35.0);
        AnchorPane.setRightAnchor(minBtn, 65.0);       
